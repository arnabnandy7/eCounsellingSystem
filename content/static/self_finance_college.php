...
<head>
<meta charset="utf-8">
<title>List of  Self Financed Institutions</title>
...
$sql_fetch_clg="select * from college_details where clgtype='self'";
...
<div align="center"><h2 style="color:#36F"><u>List of  Self Financed Institutions.</u></h2></div>
...
<br><br><br><br>
<center><INPUT TYPE='BUTTON' VALUE='Close' onClick='window.close()' style='background-color:#039; color:#FFF; font-size:18px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="download_pdf/List of self finance.pdf" target="_blank"><button style='background-color:#039; color:#FFF; font-size:18px'>Download</button></a></center>
<hr>
<div align="center">
