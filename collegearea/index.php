...
<body>
  <section class="container">
    <div class="login">
      <h1>Login to e-Counselling College Area</h1>
      <form method="post" action="check-college-login.php">
      <?php
	  if ($error==201)
	  {
	  ...
	  ?>
        <p><input type="text" name="login_id" value="" placeholder="Username or Email"></p>
    ...
    <div class="login-help">
      <p>Forgot your password? <a href="college-forgot-password.php">Click here to reset it</a>.</p>
    </div>
  </section>
